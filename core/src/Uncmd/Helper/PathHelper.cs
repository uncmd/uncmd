    ...
    public static class PathHelper
    {
        ...
        private static int CheckBuildPathParts(string[] parts)
        {
            ...
            foreach (string part in parts)
            {
                ...
                {
                    throw new ArgumentException(string.Format("One of the path parts contains invalid characters. Erroneous part is at index {0}: {1}", partIndex, part));
                }
